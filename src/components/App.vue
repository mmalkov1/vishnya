<template>
  <div>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link"
              @click="showPostingList"
            >Приходы</a>
          </li>
          <li class="nav-item">
            <a class="nav-link"
              @click="showSyncOrders">Магазин</a>
          </li>           
    ...
    ></app-edit-product>
    <app-add-product v-else-if="state === 'add-product'"></app-add-product>
    <orders v-else-if="state === 'orders'"
            @addOrder="addOrder"
            @editOrder="ShowEditOrder"></orders>
    <add-order v-else-if="state === 'add-order'"
            @addOrder="showOrdersList"></add-order> 
    <edit-order v-else-if="state === 'edit-order'"
                :orderId = "editOrderId"
    ></edit-order>  
    <app-postings
    ...
    ></app-postings>  
    <add-posting
      v-else-if="state === 'add-posting'"
      @addPosting = "showPostingList"
    ></add-posting>     
    <edit-posting
      v-else-if="state === 'edit-posting'"
      :postingId = "editPostingId"
    ></edit-posting> 
    <im-order
      v-else-if="state === 'im-orders'"
    >
    </im-order>    
