    ...
    <form class="row">
      <div class="col-4 d-flex flex-column justify-content-end">
        <div class="form-group">
          <img class="img-thumbnail" :src="product.productPhoto" :alt="product.product_name" v-if="product.productPhoto">
        </div>
        <div class="form-group">
      ...
      <div class="form-group col-8">
        <div class="col-12  row">
          <div class="form-group col-4">
            ...
            <input type="text" class="form-control" v-model="product.productArt" id="code" placeholder="Код товара">
          </div>
          <div class="form-group col-8">
            <label for="name">Название:</label>
            <input type="text" class="form-control" id="name" v-model="product.productName" placeholder="Название">
          </div>
        </div>
        <div class="col-12 row">
          <div class="form-group col-4">
            <label for="date">Дата добавления:</label>
            <input type="text" class="form-control" id="date"  placeholder="Дата добавления" disabled
                  v-model="now">
          </div>
          <div class="form-group col-8">
        ...
        <div class="col-12 row">
          <div class="form-group col-4">
            ...
            <input type="text" class="form-control" v-model="product.productUrl" id="url" placeholder="Url-адрес">
          </div>
          <div class="form-group col-8">
            <label for="exampleFormControlTextarea9">Примечания:</label>
            <textarea class="form-control" v-model="product.productComment" id="exampleFormControlTextarea9" rows="3"></textarea>
          </div>
        </div>
      </div> 
      <hr>
  ...
  methods: {
    ...
    addProduct (e) {
      ...
      axios({
        ...
        .then ((response) => {
          this.product.acc_product_prices.map((el)=>el.accProductId=response.data.id)
          axios({
            method : 'POST',
